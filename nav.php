...
<div class="container-fluid mb-5">
    <div class="row border-top px-xl-5 align-items-center">
        ...
        <div class="col-lg-10 d-flex justify-content-center">
            <nav class="navbar navbar-expand-lg bg-light navbar-light custom-navbar w-100">
        ...
        <!-- Botón de categorías a la derecha -->
        <div class="col-lg-2 d-none d-lg-block text-right">
            <a class="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100" 
               data-toggle="collapse" href="#navbar-vertical" 
               style="height: 65px; margin-top: 10px; padding: 0 30px; font-family: 'Georgia', serif; border-radius: 3px;">
